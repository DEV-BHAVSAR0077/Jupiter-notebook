# write the code for creating the interface using pytho for taking the any input file(csv,json,xml) and predicting the output using the trained linear regression model on california housing dataset and displaying the output in tabular format and also providing the download link for the output file in csv format. Use streamlit for creating the interface.
# app.py (Streamlit)
